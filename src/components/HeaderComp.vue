	...
	<header class="header" style="width: 100dvw">
		<div class="header__content">
            ...
            />
				...
				<span class="header__logo-sub" @click="header__logo_containerfunction()"
					>Mustapha Olamide</span
				>
			</div>
			<div class="header__main">
				<ul class="header__links">
					...
					<li class="header__link-wrapper">
						<a href="/#certificates" class="header__link"> Certificates </a>
					</li>
					<li class="header__link-wrapper">
						<a href="/#articles" class="header__link"> Blog </a>
					</li>
					<li class="header__link-wrapper">
			...
			<div class="header__sm-menu-content">
				<ul class="header__sm-menu-links">
					<li
						...
						v-for="(s, index) in small_links"
						:key="index"
						@click="headerSmallMenuLinksfunction()"
					>
						<a
							:href="s.link"
							:target="s.name[0] == 'B' ? '_blank' : ''"
							v-html="s.name"
						>
						</a>
					</li>
